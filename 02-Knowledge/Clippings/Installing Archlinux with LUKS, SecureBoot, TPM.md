...
source: "https://jpetazzo.github.io/2024/02/23/archlinux-luks-tpm-secureboot-install/"
author:
published:
created: 2025-11-19
description:
...
Disclaimer: there is nothing special or original about this install process. Most of the information has been gleaned from the Archlinux wiki, in particular the [Installation Guide](https://wiki.archlinux.org/title/Installation_guide). If you’re interested by the SecureBoot + TPM2 + LUKS bits, the following resources have been very helpful:

- [Rogue AI blog post](https://rogueai.github.io/posts/arch-luks-tpm/)
- [Morten Linderud blog post](https://linderud.dev/blog/mkinitcpio-v31-and-uefi-stubs/)
- [Lennart Poettering blog post](https://0pointer.net/blog/unlocking-luks2-volumes-with-tpm2-fido2-pkcs11-security-hardware-on-systemd-248.html)
...
This is fairly straightforward. This is mostly pulled from the [Archlinux installation guide](https://wiki.archlinux.org/title/Installation_guide).
