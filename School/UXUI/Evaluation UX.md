### Parcours utilisateur — de l’arrivée à l’ajout au panier

1. **Arrivée sur la page d’accueil**  
   L’utilisateur est immédiatement exposé à une forte densité d’informations : promotions, recommandations, services Prime, navigation secondaire.  
   Charge cognitive élevée dès l’entrée.

2. **Recherche d’un produit**  
   L’utilisateur utilise la barre de recherche ou navigue via les catégories.  
...
Les micro-contenus explicatifs sont limités et privilégient l’incitation à l’achat plutôt que l’aide en cas d’hésitation ou de blocage.

#### Gestion des erreurs  
D’après le critère de **gestion des erreurs**, le système est globalement robuste sur les formulaires, mais reste peu pédagogique.  
Les erreurs sont signalées, sans toujours expliquer clairement comment les corriger ou les éviter.
...
Amazon.fr propose une expérience :
